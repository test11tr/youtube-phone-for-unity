...
namespace PG
{
    ...
    public abstract class CreateVehicleWindow :EditorWindow
    {
        ...
        void SetGlassDOParams (GlassDO glassDO, MeshRenderer renderer)
        {
            ...
            glassDO.SoundShardsType = EditorHelperSettings.GlassDO.SoundShardsType;
        ...
        void SetLightObjectParams (LightObject lightObject, MeshRenderer renderer)
        {
            ...
            lightObject.SoundShardsType = EditorHelperSettings.LightObject.SoundShardsType;
        ...
        {
            var lightGO = PrefabUtility.InstantiatePrefab(refLight.gameObject, lightObject.transform) as GameObject;
        ...
        Wheel GetOrCreateWheelObject (string name, Vector2Int wheelDirectionPos)
        {
            ...
            if (wheelTR == null || wheel == null)
            {
                ...
                wheelTR.eulerAngles = new Vector3 (Selection.activeTransform.eulerAngles.x, 0, Selection.activeTransform.eulerAngles.z);
